...
그래서 탄생한 것이 <strong>BERT(Bidirectional Encoder Representations from Transformers)</strong>입니다. 이름에서 알 수 있듯이, Transformer의 <strong>Encoder만</strong> 사용하면서 양방향으로 문맥을 읽습니다.
...
BERT는 이 문제를 간결하게 해결했습니다. 입력 토큰의 15%를 무작위로 선택해 마스킹한 뒤, 모델이 양방향 문맥을 활용해 원래 토큰을 예측하도록 합니다. 이것이 <strong>Masked Language Model(MLM)</strong>입니다.
