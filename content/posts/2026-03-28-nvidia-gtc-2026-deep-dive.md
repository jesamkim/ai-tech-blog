...
### Blackwell Ultra (GB300) - 지금 출하 중

Blackwell Ultra는 현재 출하 중인 최신 세대입니다. DGX Station GB300은 72코어 Grace CPU와 Blackwell Ultra GPU를 NVLink-C2C로 연결한 데스크톱 슈퍼칩으로, <strong>748GB의 일관된 메모리</strong>와 <strong>최대 20 PFLOPS FP4 성능</strong>을 제공합니다. 1조 파라미터 규모의 AI 모델을 단일 워크스테이션에서 다룰 수 있는 수준입니다.
