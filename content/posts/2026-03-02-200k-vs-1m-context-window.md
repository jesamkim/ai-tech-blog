...
2026년 3월, Claude Sonnet 4.6과 Opus 4.6가 <strong>1M 토큰 컨텍스트 윈도우</strong>를 정식 지원하기 시작했습니다. 단일 요청으로 약 750페이지 분량의 문서를 처리할 수 있습니다. Amazon Bedrock에서도 `context-1m` 베타 기능이 활성화되면서, 기업 환경에서도 대규모 문서 처리가 가능해졌습니다.
