...
짚어둘 점 하나는 Mantle 위에 [Projects API](https://aws.amazon.com/about-aws/whats-new/2026/03/amazon-bedrock-projects-api-mantle-inference-engine/)가 별도로 얹혀 있다는 사실이다. 다중 환경·다중 팀에서 IAM 격리와 비용 태깅이 필요한 경우 한 번 살펴볼 만하다. 추가 비용은 없고 모델 추론 사용량만 과금된다. limited preview 단계의 기능들이 GA로 올라오는 시점에 다시 한 번 정리해보면 좋겠다.
