...
<strong>정확도를 최대화하려면</strong> 가장 큰 모델(GPT-4.1, Claude Opus 등)을 사용해야 합니다. 하지만 토큰당 비용이 높고, 외부 API 호출은 보안 정책에 걸릴 수 있습니다.
...
1. Teacher 모델(Claude Opus, GPT-4.1)로 학습 데이터의 Structured CoT를 생성
