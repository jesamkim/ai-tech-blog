...
NV-DINOv2 같은 Vision Foundation Model은 라벨 없는 이미지 약 100만 장으로 자기지도 학습 기반 도메인 적응을 수행한 후, 최소한의 라벨링 데이터(학습 600장, 테스트 400장)로 다이 레벨 불량 검출에서 98.51% 정확도를 기록했습니다. 이는 일반 모델의 93.84% 대비 8.9% 향상된 수치입니다.
