...
date: 2026-02-18T09:22:09+09:00
draft: false
author: "Jesam Kim"
...
![동일 모델에 서로 다른 하니스(프롬프트 포맷, 편집 방식, 컨텍스트 전략)를 적용했을 때 성능 차이가 발생하는 구조를 보여주는 개념도](/ai-tech-blog/images/posts/2026-02-18/ai-코딩-에이전트의-숨은-병목-하니스harness-모델보다-중요한-도구-인터페이스-hashline부터-편집/diagram-1.png)
...
![하니스의 세 가지 구성 요소(편집 포맷, 컨텍스트 윈도우 관리, 도구 호출 프로토콜)가 LLM 출력과 코드베이스 사이에서 중간 계층으로 작동하는 구조](/ai-tech-blog/images/posts/2026-02-18/ai-코딩-에이전트의-숨은-병목-하니스harness-모델보다-중요한-도구-인터페이스-hashline부터-편집/diagram-2.png)
...
![세 가지 편집 포맷이 연속 편집(chained edits) 시나리오에서 정확도가 어떻게 변화하는지 보여주는 비교 차트](/ai-tech-blog/images/posts/2026-02-18/ai-코딩-에이전트의-숨은-병목-하니스harness-모델보다-중요한-도구-인터페이스-hashline부터-편집/diagram-3.png)
